...
top_text_1 = Text(app, text="top_text_1", align="top", bg="#330000", color="#FFFFFF")
...
left_text_2 = Text(app, text="left_text_2", align="left", bg="#009900", color="#FFFFFF")
left_text_3 = Text(app, text="left_text_3", align="left", bg="#00FF00", color="#000000")

right_text_1 = Text(app, text="right_text_1", align="right", bg="#000033", color="#FFFFFF")
...
bottom_text_1 = Text(app, text="bottom_text_1", align="bottom", bg="#003333", color="#FFFFFF")
