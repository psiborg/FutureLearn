...
w = 80
h = 140
lst_colour = ListBox(box_colour, items=["Black", "White", "Red", "Yellow", "Green", "Cyan", "Blue", "Magenta"], align="top", width=w, height=h, selected="Black", command=change_colour)
...
# Use tkinter event <Configure> on the canvas
